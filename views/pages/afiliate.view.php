  ...
  <div class="afiliate-container">
    ...
    <section class="afilitate-info">
      ...
      <!-- <div class="afilitate-info__content">
        ...
        <h6 class="afiliate-info__coment">¿Deseas afiliarte?</h6>
        <p class="afilitate-info__parrafo">Déjanos tus datos y nos pondremos en contacto contigo
    ...
    <section class="benefPreguntas">
      <div class="preguntas">
        ...
        <h6>¿Cobro de comision?</h6>
        <p>las comisiones son retiradas mercando o por consignación a tu cuenta bancaria</p>
